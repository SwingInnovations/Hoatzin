...
public:
    ...
    Matrix4f(Vector3f& vec)
    {
        ...
        m[1][0] = 0.0; m[1][1] = vec.GetY(); m[1][2] = 0.0; m[1][1] = 0.0;
    ...
    void InitTranslation(float x, float y, float z)
    {
        ...
        m[1][0] = 0.0; m[1][1] = 1.0; m[1][2] = 0.0; m[1][1] = y;
    ...
    void InitTranslation(Vector3f& vec)
    {
        ...
        m[1][0] = 0.0; m[1][1] = 1.0; m[1][2] = 0.0; m[1][1] = vec.GetY();
    ...
    void InitScale(float x, float y, float z)
    {
        ...
        m[1][0] = 0.0; m[1][1] = y; m[1][2] = 0.0; m[1][1] = 0.0;
